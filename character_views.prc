...
[[view_character *res *character]
	...
	[campaign_tech_level *ch *campaign_tech_level] [tech_levels *campaign_tech_level *campaign_tldescription *campaign_tldate *campaign_start_wealth]
	[wealth *ch *wealth *wealth_m *wealth_n *wealth_cost]
	[languages_cost *ch *languages_cost]
		[+ *tldec *tech_level " " *tldescription " (" *tldate "). $" *start_wealth]
		[+ *campaign_tldec *campaign_tech_level " " *campaign_tldescription " (" *campaign_tldate "). $" *campaign_start_wealth]
	[*res "<td>"]
		[*res "<table width=100% style=\"border:2px solid;\" >"]
		...
		[*res "</table>"]
		[*res "<br/>"]
		;[*res "CAMPAIGN: " *campaign_tldec "<br/>"]
		[*res "<table width=100% style=\"border:2px solid;\" >"]
		...
		[*res "<td colspan=2 style='font-family: comic sans ms; font-style: italic; border-bottom: 1px solid; color: blue;'>"
			*wealth_n " $" [*wealth] " (= $" [*campaign_start_wealth] "*" [*wealth_m] ")</td>"]
...
[[view_armour *res *ch]
	...
	[ONE [*res "<tr>"] [lgdc *res *armour] [lgdc *res [*location]] [lgdc *res *note] [lgdc *res [$ *cost]] [lgdc *res [*weight]] [*res "</tr>"]]
	fail
]
[[view_armour : *]]
