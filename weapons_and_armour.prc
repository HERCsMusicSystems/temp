...
program weapons_and_armour [
				...
				weapon weapon_table weapon_mod parry_mod wp_mod aff burn cor cr cut fat imp pi- pi+ pi++ spec tox C $ No 'No skill'
					Knife 'Large Knife' 'Small Knife' 'Two-Handed Sword'
...
[[weapon *ch *weapon *tl *damage *acc *range *weight *rof *shots *cost *st *bulk *notes]
	[*ch weapon *weapon *tl *damage *acc *range *weight *rof *shots *cost *st *bulk *notes]]
[[weapon *ch *weapon *tl *damage *acc *range *weight *rof *shots *cost *st *bulk *notes]
	[*ch weapon *weapon] [ONE [damage *ch *thr *sw]]
	[weapon_table *ch *thr *sw *weapon *tl *damage *acc *range *weight *rof *shots *cost *st *bulk *notes]
]
